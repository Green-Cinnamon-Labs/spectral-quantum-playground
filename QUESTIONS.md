...
- [ ] **Q-F0** — Por que um qubit é um substrato computacional?
  ...
  - **Notebook:** [C-00](nucleo/C-00_why_qubit_computes.ipynb)
...
- [ ] **Q-F1** — O que exatamente é um estado quântico?
  ...
  - **Notebook:** [C-01](nucleo/C-01_estados_operadores_medidas.ipynb)
...
- [ ] **Q-F2** — Por que a evolução precisa ser unitária?
  ...
  - **Notebook:** [C-02](nucleo/C-02_unitarios_espectro_dinamica.ipynb)
...
- [ ] **Q-F4** — Onde entra a interferência de fato?
  ...
  - **Notebook:** [C-03](nucleo/C-03_kickback_de_fase.ipynb)
...
- [ ] **Q-C1** — O que exatamente um circuito quântico extrai de um operador?
  ...
  - **Notebook:** [C-04](nucleo/C-04_estimacao_de_fase.ipynb)
...
- [ ] **Q-C3** — Quais propriedades de um problema sobrevivem à tradução para circuito?
  ...
  - **Notebook:** [C-06](nucleo/C-06_traducao_de_problemas.ipynb)
...
- [ ] **Q-S2** — Qual a diferença entre autovalores e valores singulares?
  ...
  - **Notebook:** [C-07](nucleo/C-07_valores_singulares_vs_autovalores.ipynb)
...
- [ ] **Q-T2** — Como uma dinâmica contínua vira circuito?
  ...
  - **Notebook:** [C-05](nucleo/C-05_simulacao_hamiltoniana.ipynb) *(status: provisional — ver nota no notebook)*
...
- [ ] **Q-T5** — Quais classes de problema admitem uma tradução limpa?
  ...
  - **Notebook:** [C-06](nucleo/C-06_traducao_de_problemas.ipynb), [C-08](nucleo/C-08_qsp_qsvt_entrada.ipynb)
...
- [ ] **Q-B1** — O que QSP transforma: autovalores ou valores singulares?
  ...
  - **Notebook:** [C-08](nucleo/C-08_qsp_qsvt_entrada.ipynb)
